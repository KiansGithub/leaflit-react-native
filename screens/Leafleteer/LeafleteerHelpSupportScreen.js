...
export default function LeafleteerHelpSupportScreen({ navigation }) {
    const handleContactSupport = () => {
        Linking.openURL('mailto:support@example.com'); // Need to replace with actual support menu 
    };

    const handleFaqs = () => {
        navigation.navigate('Faqs'); // Need to implement FAQS screen 
    };
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('Leafleteer How-To Guides')}>
